...
"""
Code is borrowed and modified from https://github.com/MarcoForte/closed-form-matting on 2018-06-18.
...
def __compute_laplacian(img, mask=None, eps=10 ** (-7), win_rad=1):
...
def __closed_form_matting_with_prior(image, prior, prior_confidence, consts_map=None):
...
def closed_form_matting_with_mask(image, trimap, trimap_confidence=100.0):
    ...
    return __closed_form_matting_with_prior(
